...
function SplashCursor({
    ...
    `;
      ...
      `
        ...
        return () => {
            ...
            // Note: Event listeners are not removed as they are added to window/document
            // In a real fix, you'd store references to remove them
        };
    ...
    return (
        <div className="fixed top-0 left-0 pointer-events-none">
            <canvas ref={canvasRef} id="fluid" className="w-screen h-dvh" />
        </div>
    );
}
