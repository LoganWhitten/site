            ...
            {#if dataState.siteData}
                {#if dataState.siteData!.availablity_date === ""}
                    <p class="large-text" bind:this={statusElement}>
                        currently looking for summer '26 work
                    </p>
                {:else}
                    <p class="large-text" bind:this={statusElement}>
                        currently looking for summer '26 work
                ...
                {/if}
            {/if}
            <a class="button large-text" bind:this={fullEmailLinkElement} href="mailto:logan@loganwhitten.com" target="_blank">logan@loganwhitten.com</a>
        </div>
