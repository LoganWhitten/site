...
export default function WerkOrder() {
    ...
    useEffect(() => {
        if (items.length > prevLengthRef.current && prevLengthRef.current > 0) {
    ...
    return (
      <>
        <div className="no-print mt-8">
          <div className="bg-background border-b p-4 flex items-center justify-between">
            <h1 className="text-lg font-semibold">
              {coverInfo.showTitle || "Untitled Show"}
            </h1>
            <Button
              variant="outline"
              size="sm"
                    ...
                    .map(([cat, catItems]) => (
                      <React.Fragment key={cat}>
                        <TableRow>
                          <TableCell
                            colSpan={7}
                            className="font-bold bg-muted text-center"
                          >
                            <Button
                              variant="ghost"
                        ...
                        {catItems.map((item) => (
                          ...
                          >
                            <TableCell>
                              <Input
                                ref={(el) => {
                                  nameRefs.current.set(item.id, el);
                                }}
                                value={item.name}
                                onChange={(e) =>
                                  handleItemChange(
                                    ...
                                    <CommandList>
                                      ...
                                      {categoryInput &&
                                        !categories.some(
                                          ...
                                          <CommandItem
                                            onSelect={() =>
                                              handleCategoryAdd(item.id)
                                            }
                                          >
                                            Add &quot;{categoryInput}&quot; as new
                                            category
                                          </CommandItem>
                                        )}
                                    </CommandList>
                        ...
                        {Object.keys(groupedItems).length > 1 && (
                          <TableRow>
                            <TableCell
                              colSpan={7}
                              className="text-center border-dashed border-t-2"
                            >
                              <Button
                                variant="ghost"
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        id={`enableMultiPage-${editCategory}`}
                        checked={localEnableMultiPage}
                        onChange={(e) => {
                          const newValue = e.target.checked;
                          setLocalEnableMultiPage(newValue);
                          updateCategory(
                            editCategory!,
                            "enableMultiPage",
                            newValue
                      ...
                      />
                      <label htmlFor={`enableMultiPage-${editCategory}`}>
                        Enable Multi-Page Labeling
                      </label>
                    </div>
                    <Button
                      variant="destructive"
                      onClick={() => deleteCategory(editCategory!)}
                    >
                      Delete Category
                    </Button>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setCoverInfo({
                          ...coverInfo,
                          lightingDesigner: e.target.value,
                        })
                      }
                    />
                    <Input
                      ...
                      onChange={(e) =>
                        setCoverInfo({
                          ...coverInfo,
                          lightingDesignerContact: e.target.value,
                        })
                      }
                    />
                    <Input
                      ...
                      onChange={(e) =>
                        setCoverInfo({
                          ...coverInfo,
                          productionElectrician: e.target.value,
                        })
                      }
                    />
                    <Input
                      ...
                      onChange={(e) =>
                        setCoverInfo({
                          ...coverInfo,
                          productionElectricianContact: e.target.value,
                        })
                      }
                    />
                    <Input
        ...
        <Button
          className="no-print fixed bottom-4 right-4 rounded-full w-12 h-12 p-0"
        ...
        <div className="print-only" style={{ display: "none" }}>
          ...
          >
            <h1 style={{ fontSize: "48px", marginBottom: "50px" }}>
              {coverInfo.showTitle || "Show Title"}
            </h1>
