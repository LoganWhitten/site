          ...
          <div className="flex flex-col gap-2">
            <div>
              ...
              <h4 className="text-xs">
                All projects built entirely by me without AI.
              </h4>
            </div>
            <Project
              projectTitle="This Site"
              projectURL="https://github.com/loganwhitten/site"
              projectDesc="Next.JS containerized and running on a Raspberry PI."
            />
            <Project
              projectTitle="PunchList"
              projectURL="/punchlist"
              projectDesc="Quick app I made to track my time over the summer. (WIP)"
            />
          </div>
        </div>
      </ColorContext>
